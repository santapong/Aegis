...
const apiEndpoints = [
  {
    group: "Transactions",
    endpoints: [
      { method: "GET", path: "/api/transactions", desc: "List all transactions (with optional filters)" },
      { method: "POST", path: "/api/transactions", desc: "Create a new transaction" },
      { method: "GET", path: "/api/transactions/{id}", desc: "Get transaction by ID" },
      ...
      { method: "GET", path: "/api/transactions/summary", desc: "Get income/expense summary" },
      { method: "GET", path: "/api/transactions/export/csv", desc: "Export transactions as CSV" },
    ],
  },
  {
    group: "Plans & Goals",
  ...
  },
  {
    group: "Reports",
    endpoints: [
      { method: "GET", path: "/api/reports/monthly-comparison", desc: "Monthly category comparison" },
      { method: "GET", path: "/api/reports/anomalies", desc: "Spending anomaly detection" },
      { method: "GET", path: "/api/reports/health-score", desc: "Financial health score (0–100)" },
      { method: "GET", path: "/api/reports/cash-flow-forecast", desc: "6-month cash flow forecast" },
    ],
  },
  {
    group: "Calendar & Gantt",
    endpoints: [
      { method: "GET", path: "/api/calendar/events", desc: "List calendar events" },
      { method: "POST", path: "/api/calendar/events", desc: "Create calendar event" },
      { method: "PUT", path: "/api/calendar/events/{id}", desc: "Update calendar event" },
      { method: "DELETE", path: "/api/calendar/events/{id}", desc: "Delete calendar event" },
      { method: "GET", path: "/api/gantt/tasks", desc: "List Gantt tasks" },
      { method: "POST", path: "/api/gantt/tasks", desc: "Create Gantt task" },
      { method: "PUT", path: "/api/gantt/tasks/{id}", desc: "Update Gantt task" },
      { method: "DELETE", path: "/api/gantt/tasks/{id}", desc: "Delete Gantt task" },
    ],
  },
  {
    group: "AI & Dashboard",
