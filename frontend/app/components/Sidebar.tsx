...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 shrink-0 bg-zinc-900/80 backdrop-blur-sm border-r border-zinc-800 flex flex-col min-h-screen">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-zinc-800">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-blue-500/20">
            A
          </div>
          <div>
            <h1 className="text-base font-bold tracking-tight text-white">Aegis</h1>
            <p className="text-[10px] text-zinc-500 -mt-0.5">Wealth OS</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-0.5">
              {section.items.map((item) => {
                ...
                return (
                  ...
                  >
                    {isActive && (
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-4 rounded-r-full bg-gradient-to-b from-blue-400 to-cyan-400" />
                    )}
                    {item.icon}
                    {item.label}
                  </Link>
